...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "prescription".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "prescription_select".
 */
export interface PrescriptionSelect<T extends boolean = true> {
  name?: T;
  composition?: T;
  mainIndication?: T;
  effect?: T;
